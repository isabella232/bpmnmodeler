 ...
 * @generated
 */
public class Group2ViewFactory extends AbstractShapeViewFactory {
    ...
    protected void decorateView(View containerView, View view,
        ...
        if (semanticHint == null) {
            semanticHint = BpmnVisualIDRegistry
                    .getType(org.eclipse.stp.bpmn.diagram.edit.parts.Group2EditPart.VISUAL_ID);
        ...
        getViewService().createNode(semanticAdapter, view,
                BpmnVisualIDRegistry.getType(GroupName2EditPart.VISUAL_ID),
