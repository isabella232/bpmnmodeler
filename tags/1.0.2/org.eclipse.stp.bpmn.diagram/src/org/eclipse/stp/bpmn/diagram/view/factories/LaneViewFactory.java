...
public class LaneViewFactory extends AbstractShapeViewFactory {
    ...
    protected void decorateViewGen(View containerView, View view,
        ...
        if (semanticHint == null) {
            semanticHint = BpmnVisualIDRegistry
                    .getType(org.eclipse.stp.bpmn.diagram.edit.parts.LaneEditPart.VISUAL_ID);
        ...
        getViewService().createNode(semanticAdapter, view,
                BpmnVisualIDRegistry.getType(LaneNameEditPart.VISUAL_ID),
    ...
    protected void decorateView(View containerView, View view,
        ...
        decorateViewGen(containerView, view, semanticAdapter, semanticHint,
                index, persisted);
        View poolView = (View) containerView.eContainer();
        int parentColor = ((FillStyle) poolView
                .getStyle(NotationPackage.Literals.FILL_STYLE)).getFillColor();
        ((FillStyle) view.getStyle(NotationPackage.Literals.FILL_STYLE))
                .setFillColor(parentColor);
    }
}
