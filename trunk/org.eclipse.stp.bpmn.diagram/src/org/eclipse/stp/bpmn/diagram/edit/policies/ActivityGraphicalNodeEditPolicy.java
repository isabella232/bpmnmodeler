 ...
 * @generated
 */
public class ActivityGraphicalNodeEditPolicy extends
	...
	protected Command getReconnectTargetCommand(final ReconnectRequest request) {
		...
		AbstractTransactionalCommand command = 
			new AbstractTransactionalCommand(
				...
				getEditingDomainFor(target), BpmnDiagramMessages.ActivityGraphicalNodeEditPolicy_edge_order_command_name, null) {
					...
					protected CommandResult doExecuteWithResult(
						...
						((ActivityEditPart) getHost()).refreshSourceConnections();
						((ActivityEditPart) getHost()).refreshTargetConnections();
