...
public class PoolNameEditPart extends CompartmentEditPart implements
    ...
    protected void createDefaultEditPolicies() {
        ...
        installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
                new VerticalLabelNonResizableEditPolicy());
            ...
            ParserHintAdapter hintAdapter = new ParserHintAdapter(
                ...
                public Object getAdapter(Class adapter) {
                    if (IElementType.class.equals(adapter)) {
                        return BpmnElementTypes.Pool_1001;
                    }
    ...
    protected void setCollapsed(boolean collapsed, boolean animate) {
        VerticalLabel verticalLabel = (VerticalLabel)getFigure();
        verticalLabel.setVertical(!collapsed);
        //refreshVisuals();
    ...
    /**
     * @generated not
     * Makes sure the figure disposes its built-in image
     */
    @Override
    public void deactivate() {
        super.deactivate();
        getFigure().removeNotify();
    }
}
