 ...
 * @generated
 */
public class DataObjectNameEditPart extends CompartmentEditPart implements
        ITextAwareEditPart {
    ...
    static boolean IS_LINUX = SWT.getPlatform().equals("gtk"); //$NON-NLS-1$
            ...
            ParserHintAdapter hintAdapter = new ParserHintAdapter(
                ...
                public Object getAdapter(Class adapter) {
                    if (IElementType.class.equals(adapter)) {
                        return BpmnElementTypes.DataObject_2005;
                    }
...
//        ((DataObjectEditPart)getParent()).getFigure().setToolTip(
//                ((DataObjectEditPart)getParent()).createToolTip());
    }
