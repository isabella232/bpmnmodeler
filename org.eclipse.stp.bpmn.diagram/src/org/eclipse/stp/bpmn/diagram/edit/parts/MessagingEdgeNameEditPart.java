 ...
 * @generated
 */
public class MessagingEdgeNameEditPart extends LabelEditPart implements
        ITextAwareEditPart {
    ...
    /**
     * @generated not have the label nearer to the messaging edge
     */
    static {
        registerSnapBackPosition(BpmnVisualIDRegistry
                .getType(MessagingEdgeNameEditPart.VISUAL_ID), new Point(0, -10));
    }

    /**
     * @generated
     */
    public MessagingEdgeNameEditPart(View view) {
        super(view);
    }
            ...
            ParserHintAdapter hintAdapter = new ParserHintAdapter(
                ...
                public Object getAdapter(Class adapter) {
                    if (IElementType.class.equals(adapter)) {
                        return BpmnElementTypes.MessagingEdge_3002;
                    }
