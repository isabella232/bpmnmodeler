...
import org.eclipse.draw2d.text.TextFlowHacked;
...
public class TextFlowEx
    ...
    protected String truncateText(String text) {
        ...
        int ellipsisWidth = getTextUtilitiesHacked().getTextExtents(
        ...
        int subStringLength = getTextUtilitiesHacked().getLargestSubstringConfinedTo(
            text, currentFont, maxWidth - ellipsisWidth);

        return new String(text.substring(0, subStringLength));
    }

    public FlowUtilitiesEx getFlowUtilitiesHacked() {
    ...
    public TextUtilitiesEx getTextUtilitiesHacked() {
