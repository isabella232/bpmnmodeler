 ...
 * 
 */
public class ColorsAndFontsPropertySectionEx
               ...
               commands.add(createCommand(commandName, ((View) ep.getModel())
                    ...
                    public void run() {
                        ...
                        if (element instanceof EStructuralFeature) {
                            ...
                            editP.setStructuralFeatureValue(feature,
        ...
        while (it.hasNext()) {
            ...
            commands.add(createCommand(FONT_COMMAND_NAME,
                ((View) ep.getModel()).eResource(), new Runnable() {
                    ...
                    public void run() {
                        ((IGraphicalEditPart) ep.getParent()).setStructuralFeatureValue(NotationPackage.eINSTANCE.getFontStyle_Bold(),
        ...
        while (it.hasNext()) {
            ...
            commands.add(createCommand(FONT_COMMAND_NAME,
                ((View) ep.getModel()).eResource(), new Runnable() {
                    ...
                    public void run() {
                        ((IGraphicalEditPart) ep.getParent()).
                            setStructuralFeatureValue(NotationPackage.eINSTANCE.getFontStyle_Italic(),
        ...
        if (fontFamilyCombo.getText() != null
            ...
            while (it.hasNext()) {
                ...
                commands.add(createCommand(FONT_COMMAND_NAME, ((View) ep
                    ...
                    public void run() {
                        ((IGraphicalEditPart) ep.getParent()).
                            setStructuralFeatureValue(NotationPackage.eINSTANCE.getFontStyle_FontName(),
        ...
        if (fontSizeCombo.getText() != null
            ...
            while (it.hasNext()) {
                ...
                commands.add(createCommand(FONT_COMMAND_NAME, ((View) ep
                    ...
                    public void run() {
                        ((IGraphicalEditPart) ep.getParent()).
                            setStructuralFeatureValue(NotationPackage.eINSTANCE.getFontStyle_FontHeight(),
        ...
        executeAsReadAction(new Runnable() {
            ...
            public void run() {
                ...
                if (ep != null) {
                    ...
                    // we change the line below to ask for the primary view instead of the notation view
                    FontStyle style = (FontStyle) ep.getPrimaryView().getStyle(NotationPackage.eINSTANCE.getFontStyle());
                    ...
                    fontFamilyCombo.setText(style.getFontName());
                    fontSizeCombo.setText(Integer.toString(style.getFontHeight()));
                    fontBoldButton.setSelection(style.isBold());
                    fontItalicButton.setSelection(style.isItalic());
                }
            }
        });
        }
    ...
    protected void updateColorCache() {
        ...
        executeAsReadAction(new Runnable() {
            ...
            public void run() {
                ...
                IGraphicalEditPart ep = getSingleInput();
                if (ep != null) {
                    fontColor = FigureUtilities.integerToRGB((Integer) ((IGraphicalEditPart) ep.getParent())
